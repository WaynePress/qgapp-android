...
public class StarVideoAdapter extends BaseMultiItemQuickAdapter<VideoItemBean, BaseViewHolder> {

    public StarVideoAdapter(List<VideoItemBean> data) {
        super(data);
        setDefaultViewTypeLayout(R.layout.item_video_new);
    }
